                      ...
                      <div class="max-w-xl text-center lg:text-left">
                        <div>
                          <p class="text-3xl font-semibold tracking-tight text-[#201515] sm:text-5xl">
                            Medial Consulting System 
                          </p>
                          <p class="max-w-xl mt-4 text-base tracking-tight text-gray-600">
							We provide a platform for patients to consult with doctors online. The system is designed to make it easy and convenient for patients to consult with doctors from the comfort of their homes.
