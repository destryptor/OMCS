				...
				<div className='flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8'>
					...
					<div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
						<form className='space-y-6' action='/' method='POST' id='loginForm'>
							...
							<div>
								<button type='submit' className='flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' onClick={handleLogin}>
									Log in
								</button>
							</div>
						</form>
						...
						<p className='mt-10 text-center text-sm text-gray-500'>
							Not a member?{' '}
							<Link className='font-semibold leading-6 text-indigo-600 hover:text-indigo-500' onClick={() => setLogin(false)}>
								Sign up
							</Link>
						</p>
					</div>
				...
				<div className='flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8'>
					...
					<div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm signupForm'>
						<form className='space-y-6' action='/' method='POST'>
							...
							<div>
								<button type='submit' className='flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600' onClick={handleSignup}>
									Sign up
								</button>
							</div>
						</form>
						...
						<p className='mt-10 text-center text-sm text-gray-500'>
							Not a member?{' '}
							<Link className='font-semibold leading-6 text-indigo-600 hover:text-indigo-500' onClick={() => setLogin(true)}>
								Sign up
							</Link>
						</p>
					</div>
